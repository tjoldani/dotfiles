...
hl.bind(mainMod .. " + DELETE",        hl.dsp.exec_cmd("pactl set-sink-mute @DEFAULT_SINK@ 1 && hyprlock"))
...
hl.bind("ALT + SHIFT + H", hl.dsp.window.move({ monitor = "left" }))
hl.bind("ALT + SHIFT + L", hl.dsp.window.move({ monitor = "right" }))

-- Resize windows
hl.bind(mainMod .. " + CTRL + H", hl.dsp.window.resize({ x = -60, y =   0 }))
hl.bind(mainMod .. " + CTRL + L", hl.dsp.window.resize({ x =  60, y =   0 }))
hl.bind(mainMod .. " + CTRL + K", hl.dsp.window.resize({ x =   0, y = -60 }))
hl.bind(mainMod .. " + CTRL + J", hl.dsp.window.resize({ x =   0, y =  60 }))

-- Navigate workspaces
hl.bind(mainMod .. " + ALT + L", hl.dsp.focus({ workspace = "e+1" }))
hl.bind(mainMod .. " + ALT + H", hl.dsp.focus({ workspace = "e-1" }))

-- Switch workspaces 1-9, with 0 mapping to workspace 10
for i = 1, 9 do
